...
$statuswifi = shell_exec("sudo wpa_cli -iwlan0 list_networks");
//$statuswifi = shell_exec("whoami");
$statuswifi2 = shell_exec("sudo ifconfig wlan0 | awk '/inet addr:/ { print $2;}' "  ) . shell_exec("iwgetid ");
//$statuswifi2 = shell_exec("ifconfig wlan0 |grep 'inet addr:'"  );
//$statuswifi3 = shell_exec("iwgetid");
$statuswifi3 = shell_exec("sudo iwconfig wlan0 ");
